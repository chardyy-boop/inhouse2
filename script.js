const questions = [
    ...
    },
    {
        ...
        answer: 0 // Defaulting to A as no asterisk was provided
    },
    {
    ...
    },
    {
        ...
        answer: 0 // Default answer as none provided
    },
    {
    ...
    },
    {
        ...
        answer: 0 // Defaulting to A as no asterisk
    },
    {
...
const totalScoreQuestions = document.getElementById('total-score-questions');
...
function startQuiz() {
    ...
    totalQuestionsSpan.textContent = finalQuestions.length;
...
function loadQuestion() {
    const questionData = finalQuestions[currentQuestionIndex];

    // Update Progress
    currentQuestionNum.textContent = currentQuestionIndex + 1;
    const progressPercent = ((currentQuestionIndex + 1) / finalQuestions.length) * 100;
...
function showResults() {
    ...
    const percentage = Math.round((score / finalQuestions.length) * 100);

    scoreValue.textContent = score;
    totalScoreQuestions.textContent = finalQuestions.length;
